        ...
        for (int x=0; x<noXCells; x++) {
            for (int y=0; y<noYCells; y++) {
                ...
                switch ((int) data[y][x]) {
                    ...
                    case ESPACIO -> {
                        //pintar habitacion vacia
                        heatMapGraphics.setColor(Color.white);
                        heatMapGraphics.fillRect(cellX, cellY, cellSize.width, cellSize.height);
                    }
                    case INICIO -> {
                        //pintar punto final
                        heatMapGraphics.setColor(Color.lightGray);
                        heatMapGraphics.fillRect(cellX, cellY, cellSize.width, cellSize.height);

                        //pintar F
                        heatMapGraphics.setColor(Color.BLACK);
                        heatMapGraphics.drawString("S", cellX + 3, cellY + (cellSize.height) - 4);
                    }
                    case FINAL -> {
                        //pintar punto final
                        heatMapGraphics.setColor(Color.lightGray);
                        ...
                        //pintar S
                        heatMapGraphics.setColor(Color.BLACK);
                        heatMapGraphics.drawString("F", cellX + 3, cellY + (cellSize.height) - 4);
                    }
                    case ENCUENTRO -> {
                        //pintar punto final
                        ...
                        //pintar etiqueta
                        heatMapGraphics.setColor(Color.BLACK);
                        heatMapGraphics.drawString("E", cellX + 3, cellY + (cellSize.height) - 4);
                    }
                    case CAMINO -> {
                        //pintar camino
                    ...
                    default -> {
                        ...
                        //pintar los numeros
                        heatMapGraphics.setColor(Color.BLACK);
                        profundidad = Integer.toString((int) data[y][x]);
                        heatMapGraphics.drawString(profundidad, cellX + 3, cellY + (cellSize.height) - 4);
                    }
                }
            }
        }
